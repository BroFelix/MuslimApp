...
import 'package:hijri_calendar/src/hijri_builder.dart';

import 'src/calendar/hijri_calendar.dart';
export 'src/hijri_builder.dart';
...
class HijriDatePickerDialog extends StatefulWidget {
  ...
  @override
  State<HijriDatePickerDialog> createState() => _DatePickerDialogState();
}
...
class _DatePickerDialogState extends State<HijriDatePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final Dialog dialog = Dialog(child: OrientationBuilder(builder: (
...
class HijriMonthPicker extends StatefulWidget {
  ...
  @override
  State<HijriMonthPicker> createState() => _HijriMonthPickerState();
}
...
class HijriYearPicker extends StatefulWidget {
  ...
  @override
  State<HijriYearPicker> createState() => _HijriYearPickerState();
}
